...
namespace Controle_De_OS.Controllers
{
    public class CidadesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,descricao,estado")] Cidade cidade)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,descricao,estado")] Cidade cidade)
        {
            if (id != cidade.Id)
            {
                return NotFound();
